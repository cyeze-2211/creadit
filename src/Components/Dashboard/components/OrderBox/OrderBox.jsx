            ...
            <Card className="w-full bg-white rounded-3xl shadow-xl border border-gray-200 flex flex-col">
              <CardBody className="flex flex-col items-start p-4">
                ...
                <div className="mb-2 w-full">
                  ...
                  <div className="text-gray-800 text-sm">
                    <span className="font-semibold">Bo'lib to'lash:</span> {order.product?.Installment} USD
                  </div>
                  <div className="text-gray-800 text-sm">
                    <span className="font-semibold">Oylik to'lov oyi:</span> {order.product?.monthly_payment} 
                  </div>
                  <div className="text-gray-800 text-sm">
